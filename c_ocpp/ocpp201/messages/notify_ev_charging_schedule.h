#ifndef OCPP201_NOTIFY_EV_CHARGING_SCHEDULE_H
#define OCPP201_NOTIFY_EV_CHARGING_SCHEDULE_H
...
extern "C" {
#endif
#define OCPP201_NOTIFY_EV_CHARGING_SCHEDULE_ACTION "NotifyEVChargingSchedule"
typedef struct ocpp201_notify_ev_charging_schedule_req {
    char timeBase[33];
    int evseId;
    ocpp201_charging_schedule_t chargingSchedule;
} ocpp201_notify_ev_charging_schedule_req_t;
typedef struct ocpp201_notify_ev_charging_schedule_conf {
    char status[17];
} ocpp201_notify_ev_charging_schedule_conf_t;
