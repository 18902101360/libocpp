#ifndef OCPP201_SET_VARIABLES_H
#define OCPP201_SET_VARIABLES_H
...
extern "C" {
#endif
#define OCPP201_SET_VARIABLES_ACTION "SetVariables"
typedef struct ocpp201_set_variables_req {
    int setVariableData_count;
    ocpp201_set_var_data_t setVariableData[4];
} ocpp201_set_variables_req_t;
typedef struct ocpp201_set_variables_conf {
    int setVariableResult_count;
    ocpp201_set_var_result_t setVariableResult[4];
} ocpp201_set_variables_conf_t;
