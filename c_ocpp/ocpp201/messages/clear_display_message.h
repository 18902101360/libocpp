#ifndef OCPP201_CLEAR_DISPLAY_MESSAGE_H
#define OCPP201_CLEAR_DISPLAY_MESSAGE_H
...
extern "C" {
#endif
#define OCPP201_CLEAR_DISPLAY_MESSAGE_ACTION "ClearDisplayMessage"
typedef struct ocpp201_clear_display_message_req {
    int id;
} ocpp201_clear_display_message_req_t;
typedef struct ocpp201_clear_display_message_conf {
    char status[17];
} ocpp201_clear_display_message_conf_t;
