#ifndef OCPP201_GET_CERTIFICATE_STATUS_H
#define OCPP201_GET_CERTIFICATE_STATUS_H
...
extern "C" {
#endif
#define OCPP201_GET_CERTIFICATE_STATUS_ACTION "GetCertificateStatus"
typedef struct ocpp201_get_certificate_status_req {
    ocpp201_ocsp_t ocspRequestData;
} ocpp201_get_certificate_status_req_t;
typedef struct ocpp201_get_certificate_status_conf {
    char status[17];
} ocpp201_get_certificate_status_conf_t;
