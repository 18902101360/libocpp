#ifndef OCPP201_GET_LOCAL_LIST_VERSION_H
#define OCPP201_GET_LOCAL_LIST_VERSION_H
...
extern "C" {
#endif
#define OCPP201_GET_LOCAL_LIST_VERSION_ACTION "GetLocalListVersion"
typedef struct ocpp201_get_local_list_version_req {
    int unused;
} ocpp201_get_local_list_version_req_t;
typedef struct ocpp201_get_local_list_version_conf {
    int versionNumber;
} ocpp201_get_local_list_version_conf_t;
