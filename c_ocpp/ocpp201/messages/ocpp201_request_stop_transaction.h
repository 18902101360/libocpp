#ifndef OCPP201_REQUEST_STOP_TRANSACTION_H
#define OCPP201_REQUEST_STOP_TRANSACTION_H
...
extern "C" {
#endif
#define OCPP201_REQUEST_STOP_TRANSACTION_ACTION "RequestStopTransaction"
typedef struct ocpp201_request_stop_transaction_req {
    char transactionId[37];
} ocpp201_request_stop_transaction_req_t;
typedef struct ocpp201_request_stop_transaction_conf {
    char status[17];
} ocpp201_request_stop_transaction_conf_t;
