#ifndef OCPP201_SET_NETWORK_PROFILE_H
#define OCPP201_SET_NETWORK_PROFILE_H
...
extern "C" {
#endif
#define OCPP201_SET_NETWORK_PROFILE_ACTION "SetNetworkProfile"
typedef struct ocpp201_set_network_profile_req {
    int configurationSlot;
    ocpp201_network_connection_t connectionData;
} ocpp201_set_network_profile_req_t;
typedef struct ocpp201_set_network_profile_conf {
    char status[17];
} ocpp201_set_network_profile_conf_t;
