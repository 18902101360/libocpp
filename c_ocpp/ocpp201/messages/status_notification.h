#ifndef OCPP201_STATUS_NOTIFICATION_H
#define OCPP201_STATUS_NOTIFICATION_H
...
extern "C" {
#endif
#define OCPP201_STATUS_NOTIFICATION_ACTION "StatusNotification"
typedef struct ocpp201_status_notification_req {
    char timestamp[33];
    char connectorStatus[21];
    int evseId;
    int connectorId;
} ocpp201_status_notification_req_t;
typedef struct ocpp201_status_notification_conf {
    int unused;
} ocpp201_status_notification_conf_t;
