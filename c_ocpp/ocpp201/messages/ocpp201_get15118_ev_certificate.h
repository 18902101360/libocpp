#ifndef OCPP201_GET15118_EV_CERTIFICATE_H
#define OCPP201_GET15118_EV_CERTIFICATE_H
...
extern "C" {
#endif
#define OCPP201_GET15118_EV_CERTIFICATE_ACTION "Get15118EVCertificate"
typedef struct ocpp201_get15118_ev_certificate_req {
    char iso15118SchemaVersion[51];
    char action[17];
    char exiRequest[513];
} ocpp201_get15118_ev_certificate_req_t;
typedef struct ocpp201_get15118_ev_certificate_conf {
    char status[17];
    char exiResponse[513];
} ocpp201_get15118_ev_certificate_conf_t;
