#ifndef OCPP201_UNLOCK_CONNECTOR_H
#define OCPP201_UNLOCK_CONNECTOR_H
...
extern "C" {
#endif
#define OCPP201_UNLOCK_CONNECTOR_ACTION "UnlockConnector"
typedef struct ocpp201_unlock_connector_req {
    int evseId;
    int connectorId;
} ocpp201_unlock_connector_req_t;
typedef struct ocpp201_unlock_connector_conf {
    char status[17];
} ocpp201_unlock_connector_conf_t;
