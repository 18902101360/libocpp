#ifndef OCPP201_CLEARED_CHARGING_LIMIT_H
#define OCPP201_CLEARED_CHARGING_LIMIT_H
...
extern "C" {
#endif
#define OCPP201_CLEARED_CHARGING_LIMIT_ACTION "ClearedChargingLimit"
typedef struct ocpp201_cleared_charging_limit_req {
    char chargingLimitSource[21];
} ocpp201_cleared_charging_limit_req_t;
typedef struct ocpp201_cleared_charging_limit_conf {
    int unused;
} ocpp201_cleared_charging_limit_conf_t;
