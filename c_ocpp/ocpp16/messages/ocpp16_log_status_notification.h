...
#ifndef OCPP16_LOG_STATUS_NOTIFICATION_H
#define OCPP16_LOG_STATUS_NOTIFICATION_H
...
#define OCPP16_LOG_STATUS_NOTIFICATION_ACTION "LogStatusNotification"

typedef struct ocpp16_log_status_notification_req {
    char status[21];
    int has_requestId;
    int requestId;
} ocpp16_log_status_notification_req_t;

typedef struct ocpp16_log_status_notification_conf {
    int unused;
} ocpp16_log_status_notification_conf_t;
